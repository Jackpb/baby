...
package com.babyangel.utils;

import com.babyangel.entity.ColumnEntity;
import com.babyangel.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "com.babyangel" : mainPath;
		...
		map.put("moduleNameZh", config.getString("moduleNameZh" ));
