...
import com.babyangel.common.exception.user.UserBlockedException;
...
import com.babyangel.common.utils.*;
...
//        //2、退出日志写入数据库
//        //AsyncManager.me().execute(AsyncFactory.recordLogininfor(user.getUsername(), BabyConstants.LOGOUT, MessageUtils.message("user.logout.success")));
//        ShiroUtils.logout();
