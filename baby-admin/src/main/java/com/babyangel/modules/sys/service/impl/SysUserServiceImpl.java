...
import com.babyangel.common.annotation.DataFilter;
...
import com.babyangel.modules.sys.dao.SysUserDao;
...
import com.babyangel.modules.sys.service.SysUserRoleService;
...
//		Wrapper<SysUserEntity> wrapper = Condition.create().eq("username",userName);
//		List<SysUserEntity> sysUserEntityList = this.selectList(wrapper);
...
//		}
	...
	@Override
	public SysUserEntity selectUserByPhoneNumber(String phone) {
		SysUserEntity user = new SysUserEntity();
