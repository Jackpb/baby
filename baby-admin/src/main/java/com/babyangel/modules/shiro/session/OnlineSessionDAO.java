...
public class OnlineSessionDAO extends EnterpriseCacheSessionDAO
{
    ...
    {
        SysUserOnlineEntity userOnline = onlineService.selectOnlineBySessionId(String.valueOf(sessionId));
        if (userOnline == null)
        {
            return null;
        }
    ...
    protected void doDelete(Session session)
    {
        ...
        onlineService.deletedBySessionId(String.valueOf(onlineSession.getId()));
