...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.goods.goodsId == null ? "good/goods/save" : "good/goods/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		getInfo: function(goodsId){
			$.get(baseURL + "good/goods/info/"+goodsId, function(r){
                vm.goods = r.goods;
            });
		},
